...
dir.create(paste(root_dir, "Ascending_neuron_screen_analysis_pipeline/output/Fig2_S4-GLM_jangles_legs_beh_DFF/glm_input_files/",sep=""))
...
for (example in examples){
    ...
    print(genotype)
    dir.create(paste(root_dir,"Ascending_neuron_screen_analysis_pipeline/output/Fig4a5a6a7b8a9a10a-representativeDFF_traces/plots/", genotype, sep=""))
    regressor <- unlist(example["Regressor"])
    df <- read.csv.with.nan(paste(root_dir, "Ascending_neuron_screen_analysis_pipeline/output/Fig2_S4-GLM_jangles_legs_beh_DFF/glm_input_files/", genotype, ".csv", sep=""))
    ...
    for (roi in rois){
        ...
        for (trial in trials){
            ...
            output_file <- paste(root_dir,"Ascending_neuron_screen_analysis_pipeline/output/Fig4a5a6a7b8a9a10a-representativeDFF_traces/", genotype, "/", genotype, "_Trial", trial, "_ROI", roi, ".pdf", sep="")
