...
florian_glm_dir= NAS_AN_Proj_Dir+'output/FigED4_ED5-overview_matrices_jangle_Rest/plots/' 
...
glm_janlges_SN_dir=florian_glm_dir+'glm_jangle_SN/'
if not os.path.exists(glm_janlges_SN_dir):
	os.makedirs(glm_janlges_SN_dir)
lm_jangles_SN_df=pd.read_csv(NAS_AN_Proj_Dir+'output/FigED4_ED5-overview_matrices_jangle_Rest/overview_angles_SN/lm_results_angles.csv')


glm_janlges_SN_rest_dir=florian_glm_dir+'glm_jangle_SN_rest/'
if not os.path.exists(glm_janlges_SN_rest_dir):
	os.makedirs(glm_janlges_SN_rest_dir)
lm_jangles_SN_rest_df=pd.read_csv(NAS_AN_Proj_Dir+'output/FigED4_ED5-overview_matrices_jangle_Rest/overview_angles_SN_rest/lm_results_angles.csv')



glm_janlges_AN_rest_dir=florian_glm_dir+'glm_jangle_AN_rest/'
if not os.path.exists(glm_janlges_AN_rest_dir):
	os.makedirs(glm_janlges_AN_rest_dir)
lm_jangles_AN_rest_df=pd.read_csv(NAS_AN_Proj_Dir+'output/FigED4_ED5-overview_matrices_jangle_Rest/overview_angles_AN_rest/lm_results_angles.csv')
...
whole_set_df=[
(lm_jangles_SN_df, 'jangle_SN'),
(lm_jangles_SN_rest_df, 'jangle_SN_rest'),
(lm_jangles_AN_rest_df, 'jangle_AN_rest'),
]
...
for df, df_tag in whole_set_df:
	...
	if df_tag=='jangle_SN':
		glm_dir=glm_janlges_SN_dir

	elif df_tag=='jangle_SN_rest':
		glm_dir=glm_janlges_SN_rest_dir

	elif df_tag=='jangle_AN_rest':
		glm_dir=glm_janlges_AN_rest_dir
