...
n_repetitions <- 5
base_folder <- paste(root_dir, "Ascending_neuron_screen_analysis_pipeline/output/Fig7a_7c-turning/", sep="")
...
# genotype.order <- read.csv(paste(root_dir, "Ascending_neuron_screen_analysis_pipeline/scripts_for_public/utils/genotype_order.csv")[["x"]]
