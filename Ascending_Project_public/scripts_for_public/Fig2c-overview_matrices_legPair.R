...
# print(paste(root_dir,"Ascending_Project_public/output/Fig2_S4-GLM_jangles_legs_beh_DFF/crf_parameters.csv", sep=""))
...
# folder <- paste(root_dir,"Ascending_Project_public/output/Fig2_S4-GLM_jangles_legs_beh_DFF/overview_beh/", sep="")      
# dir.create(folder)
# intercept <- TRUE
# standardize <- FALSE
...
# folder <- paste(root_dir,"Ascending_Project_public/output/Fig2_S4-GLM_jangles_legs_beh_DFF/overview_angles/", sep="")                     
# dir.create(folder)
# intercept <- TRUE
# standardize <- TRUE
# standardize.response <- FALSE
...
# folder <- paste(root_dir,"Ascending_Project_public/output/Fig2_S4-GLM_jangles_legs_beh_DFF/overview_legs/", sep="")           
...
folder <- paste(root_dir,"Ascending_Project_public/output/Fig2_S4-GLM_jangles_legs_beh_DFF/overview_leg_pairs/", sep="")           
dir.create(folder)
intercept <- TRUE
standardize <- TRUE
standardize.response <- FALSE
...
# for (path in Sys.glob(paste(root_dir,"Ascending_Project_public/output/Fig2_S4-GLM_jangles_legs_beh_DFF/behavior_prediction_paper_original_version/glm_input_files/[SRM]*.csv", sep=""))){
for (path in Sys.glob(paste(root_dir,"Ascending_Project_public/output/Fig2_S4-GLM_jangles_legs_beh_DFF/glm_input_files/[SRM]*.csv", sep=""))){
