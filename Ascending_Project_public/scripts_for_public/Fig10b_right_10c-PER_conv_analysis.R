...
dir.create(paste(root_dir, "Ascending_Project_public/output/Fig10a_10c-PE_analysis/plots/", sep=""))
...
df <- read.csv.with.nan(paste(root_dir, "Ascending_Project_public/output/Fig2_S4-GLM_jangles_legs_beh_DFF/glm_input_files/SS31232.csv", sep=""))
...
write.csv(results, paste(root_dir, "Ascending_Project_public/output/Fig10a_10c-PE_analysis/PER_results.csv", sep=""))
results <- read.csv(paste(root_dir, "Ascending_Project_public/output/Fig10a_10c-PE_analysis/PER_results.csv", sep=""))
...
ggsave(paste(root_dir, "Ascending_Project_public/output/Fig10a_10c-PE_analysis/plots/PER.pdf", sep=""), height=6, width=15, scale=0.25, device=cairo_pdf)
    ...
    for (position in c("masked_pre")){
        ...
        for (regressor in regressors){
            ...
            for (trial in unique(roi_df$Trial)){
                ...
                output_file <- paste(paste(root_dir, "Ascending_Project_public/output/Fig10a_10c-PE_analysis/plots/Trial", sep=""), trial, "ROI", roi, regressor, ".pdf", sep="_")
                print(output_file)
